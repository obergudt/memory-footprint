...
(function() {
  var ProgressBar, argv, bar, c, checkMod, contents, e, finalStats, fs, index, key, loadedMods, measureCount, measureInterval, mods, path, relevantDir, relevantFile, results, runCount, runDelay, runs;
  ...
  checkMod = function(index) {
    var _, aggregate, i, initial, interval, item, j, k, l, len, len1, len2, len3, m, measurePoints, moduleMeasureCount, ref, result, resultItem, sorted, stats, value;
