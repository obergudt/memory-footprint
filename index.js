...
(function() {
  var ProgressBar, _, argv, bar, c, calculationStrategy, checkMod, contents, e, finalStats, fs, index, key, loadedMods, measureCount, measureInterval, mods, path, relevantDir, relevantFile, results, runCount, runDelay, runs;
